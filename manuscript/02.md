...
In the last chapter, I've shown how to leverage Schematics, the Angular CLI's code generator, to scaffold custom components. This chapter goes one step further and shows how to register generated building blocks like Components, Directives, Pipes, or Services with an existing ``NgModule``. For this I'll extend the example from the last article that generates a ``SideMenuComponent``. The [source code shown here](https://github.com/manfredsteyer/schematics-sample) can also be found in my [GitHub repository](https://github.com/manfredsteyer/schematics-sample).
...
![Utils for custom Rule](images/aFaE7ZU.png)
...
![Calling Schematic which generated component and registers it with the module](images/Kciv0Na.png)
