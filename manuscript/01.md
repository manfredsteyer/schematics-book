...
In this post, I'm showing how to create a collection with a custom Schematic from scratch and how to use it with an Angular project. The [sources](https://github.com/manfredsteyer/schematics-intro) can be found [here](https://github.com/manfredsteyer/schematics-intro).
...
![Solution](https://i.imgur.com/6Tqcekm.png)
...
![npm package with collection](https://i.imgur.com/BDZ1UnF.png)
...
![Structure for custom Schematics](https://i.imgur.com/j91lJce.png)
...
![Folder with Templates](https://i.imgur.com/9PLdfyo.png)
...
![Using the Schematic](https://i.imgur.com/y9UFc54.png)
